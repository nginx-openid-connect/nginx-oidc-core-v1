...
- **R29** Access token support. Added support for access token for API authorization. Additional endpoints of `/login`, `/v2/logout` and `/userinfo`. Bundle frontend app and Dockerfile to test full life cycle of OIDC flow locally on a container.
